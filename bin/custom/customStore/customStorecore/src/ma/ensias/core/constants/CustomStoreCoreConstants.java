 ...
 */
package ma.ensias.core.constants;

/**
 * Global class for all CustomStoreCore constants. You can add global constants for your extension into this class.
 */
public final class CustomStoreCoreConstants extends GeneratedCustomStoreCoreConstants
{
	public static final String EXTENSIONNAME = "customStorecore";


	private CustomStoreCoreConstants()
	{
		//empty
	}
