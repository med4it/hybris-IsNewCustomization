...
import ma.ensias.test.constants.CustomStoreTestConstants;
import ma.ensias.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CustomStoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/customStoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/customStoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/customStoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/customStoretest/import/csquotes.impex");
		}
	}
}
