 ...
 */
package ma.ensias.fulfilmentprocess.test.jobs;
...
import ma.ensias.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CustomStoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
