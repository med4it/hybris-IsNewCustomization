 ...
 */
package ma.ensias.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CustomStoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CustomStoreFulfilmentProcessConstants.PARENT_PROCESS);
